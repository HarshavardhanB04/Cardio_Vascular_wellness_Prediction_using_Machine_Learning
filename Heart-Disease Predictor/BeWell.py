...
with st.sidebar :
    selected = option_menu('Heart-Disease Predictor',['Diabetes Prediction','Heart Disease Prediction','others']
...
if(selected == 'Diabetes Prediction'):
    # page title
    st.title('Heart-Disease Predictor Diabetes Predictor')
...
if(selected == 'Heart Disease Prediction'):
    #page title
    st.title('Heart-Disease Predictor Heart Disease Predictor')
    col1, col2, col3 = st.columns(3)
